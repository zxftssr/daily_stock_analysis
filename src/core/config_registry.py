...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "REALTIME_SOURCE_PRIORITY": {
        ...
        "description": "Comma-separated priority for realtime quote providers; public_auto uses Tencent, Sina, then Eastmoney with protected fallback.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        "is_required": False,
        "is_editable": True,
        "default_value": "public_auto,efinance,akshare_em",
        "options": [],
        "validation": {},
        "display_order": 20,
    },
